<head><link rel="stylesheet" type="text/css" href="./styles.css"/></head>
    <body><div id="ikdb">hi</div><p id="is7s">This is a paragraph</p><section><h1>Section Title</h1><p>Content here</p></section><footer><p>Footer content here</p></footer><a href="#">Click me</a><ul><li>List Item 1</li><li>List Item 2</li></ul></body>
    <div class="footer">
        <div class="form">       
