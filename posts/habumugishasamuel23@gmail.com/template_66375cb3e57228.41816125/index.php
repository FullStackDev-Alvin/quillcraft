<head><link rel="stylesheet" type="text/css" href="./styles.css"/></head>
    <body id="i1bw"><img src="../../images/66375c3b2dbea_pexels-andre-furtado-43594-1264210.jpg" alt="Placeholder" id="i4r7"/><section><h1 id="i8td">My blog site</h1><p id="ixh7">all about photography</p></section></body>
    <div class="footer">
        <div class="form">       
